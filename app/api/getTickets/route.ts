...
export async function GET(req: Request) {
  ...
  r.resolution_text,
  r.resolution_by,
  ur.full_name AS resolution_by_name,
  r.resolution_at
...
-- JOIN resolution ก่อน
LEFT JOIN ticket_resolution r ON t.ticket_id = r.ticket_id
LEFT JOIN m_users ur          ON r.resolution_by = ur.user_id
